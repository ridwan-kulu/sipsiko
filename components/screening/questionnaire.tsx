...
const standardOptions = [
  {
    label: "Tidak pernah",
    description: "Tidak terjadi dalam dua minggu terakhir.",
    value: 0,
  },
  {
    label: "Beberapa hari",
  ...
  },
  {
    ...
    description: "Terjadi hampir setiap hari.",
    value: 1,
  },
];
...
const crisisOptions = [
  {
    label: "Tidak",
    description: "Saya tidak memiliki dorongan tersebut.",
    value: 0,
  },
  {
    label: "Ya",
    description: "Saya memiliki dorongan tersebut saat ini.",
    value: 1,
  },
];
...
export function Questionnaire({
      ...
      <main className="grid min-h-screen place-items-center px-5">
        <section className="text-center">
          ...
          <p className="mt-3 text-slate-600">
            Belum ada gejala aktif di basis pengetahuan.
          </p>
        </section>
      </main>
    );
  ...
  function goBack() {
    if (currentIndex === 0) {
      router.push("/skrining/persetujuan");
      return;
    }
  ...
  async function submitAnswers() {
    try {
      ...
      const consentedAt = sessionStorage.getItem(
        "screeningConsent",
      );

      if (!consentedAt) {
        router.replace("/skrining/persetujuan");
        return;
      }
      ...
      const requestAnswers: ScreeningAnswer[] =
        questions.map((question) => ({
          ...
          userWeight: answers[question.id] ?? 0,
          durationDays: 14,
        }));
    ...
    <main className="min-h-screen bg-[#f8faf9]">
      ...
      <div className="mx-auto max-w-3xl px-5 py-8 sm:px-8 sm:py-12">
        ...
        <section className="mt-6 rounded-2xl border border-[#dfe6e2] bg-white p-6 sm:p-9">
          ...
          <h1 className="mt-3 text-2xl leading-9 font-bold sm:text-3xl">
                  ...
                  <span
                    ...
                    className={
                      isSelected
                        ...
                        : "size-5 rounded-full border-2 border-slate-300"
                    }
                  />
                </button>
              );
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="mt-2 text-sm leading-6">
                    Hubungi orang yang dipercaya, tenaga
                    kesehatan, atau layanan darurat setempat
                    sekarang.
                  </p>
                </div>
              </div>
          ...
          <div className="mt-8 flex justify-between gap-3">
            <button
              type="button"
              onClick={goBack}
              className="inline-flex min-h-12 items-center gap-2 rounded-lg border border-[#dfe6e2] px-5 font-semibold"
            >
              <ArrowLeft
                aria-hidden="true"
                size={18}
            ...
            {!hasCrisisAnswer && (
              <button
                ...
                className="inline-flex min-h-12 items-center gap-2 rounded-lg bg-[#146b58] px-5 font-semibold text-white disabled:bg-slate-300"
              >
                {isSubmitting ? (
                  <>
                    <LoaderCircle
